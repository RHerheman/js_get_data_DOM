...
document.querySelector('span.total-population').textContent = formatNumber(total);
document.querySelector('span.average-population').textContent = formatNumber(Math.round(average));
